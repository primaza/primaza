...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceClaimApplication) DeepCopyInto(out *ServiceClaimApplication) {
	*out = *in
	if in.Selector != nil {
		in, out := &in.Selector, &out.Selector
		*out = new(v1.LabelSelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceClaimApplication.
func (in *ServiceClaimApplication) DeepCopy() *ServiceClaimApplication {
	if in == nil {
		return nil
	}
	out := new(ServiceClaimApplication)
	in.DeepCopyInto(out)
	return out
}
