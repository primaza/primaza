    ...
    Scenario: Application Namespace exists
        ...
        spec:
          ...
          applicationClusterContext:
            clusterEnvironmentName: primaza-worker
            namespace: applications
          application:
            kind: Deployment
            apiVersion: apps/v1
        ...
        And On Worker Cluster "primaza-worker", ServiceBinding "sc-test" on namespace "applications" state will eventually move to "Ready"
