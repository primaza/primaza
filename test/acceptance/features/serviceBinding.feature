    ...
    Scenario: Service binding projection of a secret into an application with direct reference
        ...
        spec:
            ...
            application:
                ...
                kind: Deployment
        """
        Then jsonpath ".status.conditions[] | select(.type=="ValidResource") | .status" on "servicebindings.primaza.io/newapp-binding:applications" in cluster main is "True"
        And  jsonpath ".status.conditions[] | select(.type=="ValidResource") | .reason" on "servicebindings.primaza.io/newapp-binding:applications" in cluster main is "ValidationSucceeded"
    ...
    Scenario: Agents bind application on Worker Cluster
        ...
        spec:
            ...
            application:
                ...
                kind: Deployment
        """
        Then jsonpath ".status.conditions[] | select(.type=="ValidResource") | .status" on "servicebindings.primaza.io/app-binding:applications" in cluster worker is "True"
        And  jsonpath ".status.conditions[] | select(.type=="ValidResource") | .reason" on "servicebindings.primaza.io/app-binding:applications" in cluster worker is "ValidationSucceeded"
        And  On Worker Cluster "worker", ServiceBinding "app-binding" in namespace "applications" state will eventually move to "Ready"
            ...
            application:
                ...
                selector:
                    matchLabels:
                        app: myapp
        """
        Then jsonpath ".status.conditions[] | select(.type=="ValidResource") | .status" on "servicebindings.primaza.io/application-binding:applications" in cluster main is "True"
        And  jsonpath ".status.conditions[] | select(.type=="ValidResource") | .reason" on "servicebindings.primaza.io/application-binding:applications" in cluster main is "ValidationSucceeded"
    ...
    Scenario: Service Binding without application name and labels selector
        ...
        spec:
            ...
            application:
                ...
                kind: Deployment
        """
        Then jsonpath ".status.state" on "servicebindings.primaza.io/newapp-binding:applications" in cluster main is "Malformed"
        And  jsonpath ".status.conditions[] | select(.type=="ValidResource") | .status" on "servicebindings.primaza.io/newapp-binding:applications" in cluster main is "False"
        And  jsonpath ".status.conditions[] | select(.type=="ValidResource") | .reason" on "servicebindings.primaza.io/newapp-binding:applications" in cluster main is "MissingField"
