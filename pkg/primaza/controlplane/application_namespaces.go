...
func PushServiceBinding(
	ctx context.Context,
	sc *primazaiov1alpha1.ControlPlaneServiceClaim,
...
func DeleteServiceBindingAndSecretFromNamespaces(ctx context.Context, cli client.Client, sc primazaiov1alpha1.ControlPlaneServiceClaim, namespaces []string) error {
	var errs []error
