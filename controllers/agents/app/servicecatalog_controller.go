...
//+kubebuilder:rbac:groups=primaza.io.primaza.io,resources=servicecatalogs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=primaza.io.primaza.io,resources=servicecatalogs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=primaza.io.primaza.io,resources=servicecatalogs/finalizers,verbs=update
